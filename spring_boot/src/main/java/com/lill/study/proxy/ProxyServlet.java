        ...
        if (servletRequest.getHeader(HttpHeaders.CONTENT_LENGTH) != null ||
            ...
            if (method.equals("POST")) {
                ...
                while (parameterNames.hasMoreElements()) {
                    ...
                    pairs.add(new BasicNameValuePair(name, servletRequest.getParameter(name)));
                }
                ((HttpPost) proxyRequest).setEntity(new UrlEncodedFormEntity(pairs, HTTP.UTF_8));
            } else {
